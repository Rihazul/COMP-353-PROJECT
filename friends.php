...
PostID	int	NO	PRI		auto_increment
MemberID	int	NO	MUL		
GroupID	int	YES	MUL		
TextContent	text	NO			
AttachmentContent	blob	YES			
DatePosted	datetime	YES		CURRENT_TIMESTAMP	DEFAULT_GENERATED
ModerationStatus	enum('Pending','Approved','Rejected')	YES		Pending	
